...
var _default = self => (0, _litElement.html)`
...
class AppMain extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)`<style>${_style.default}</style> ${(0, _template.default)(this)}`;
  }
